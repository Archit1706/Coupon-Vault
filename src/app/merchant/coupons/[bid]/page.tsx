            ...
            <tbody>
              ...
              {coupon.isStatic ? (
                <tr className=" border-b bg-white dark:bg-gray-800">
                  ...
                  <td className="px-6 py-4">
                    <Link href={`/merchant/campaigns/${coupon.campainId.$oid}`}>
              ...
              <tr className="border-b bg-white dark:bg-gray-800">
                ...
                {!isOwner ? (
                  <td className="px-6 py-4">Not Redeemed Yet</td>
                ) : (
              ...
              <tr className=" border-b bg-white dark:bg-gray-800">
                ...
                <td className="px-6 py-4">
                  {getDateFromDays(nanosecondsToDays(coupon.createdAt.$date.$numberLong))}
                </td>
              </tr>
