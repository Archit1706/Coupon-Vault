        ...
        <div>
            <div className="flex flex-col items-center ">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                    ...
                    {getDateFromDays(nanosecondsToDays(user.Customer_For))}
                </p>
                    ...
                    <div className="flex-1 bg-white dark:bg-black rounded-lg shadow-xl p-8">
                        ...
                        <ul className="mt-2 text-gray-700">
                            ...
                            <li className="flex border-b py-2 justify-between">
                                ...
                                <span className="text-gray-400 ">
                                    Belongs to Cluster No : {user.Clusters}
                                </span>
                                <span className="text-gray-400 "></span>
                            </li>
                            <li className="flex border-b py-2 justify-between">
                                ...
                                <span className="text-gray-400">
                                    {user.NumDealsPurchases} Deals Made in Total
                                </span>
                                <span className="text-gray-400 "></span>
                            </li>
                            <li className="flex border-b py-2 justify-between">
                                ...
                                <span className="text-gray-400">
                                    {user.NumWebVisitsMonth} No of times visits
                                    per months
                                </span>
                                <span className="text-gray-400 "></span>
                            </li>
