...
import "./globals.css";
import image1 from "/assets/landing/fggg.jpg";
import image2 from "/assets/landing/222-min.png";
import "/assets/landing/others/ns.css";
import "/assets/landing/others/Landing.css";
//import "/assets/landing/others/jquery.js"
//import "/assets/landing/others/ns.js"

type Props = {};

const Home = (props: Props) => {
    const router = useRouter();
    const [dtoggle, setDtoggle] = React.useState(false);
    const [mtoggle, setMtoggle] = React.useState(false);
    ...
    return (
        <div>
            <section className="u-clearfix u-white u-section-1" id="sec-18b1">
                <div className="u-clearfix u-layout-wrap u-layout-wrap-1">
                    <div className="u-layout">
                        <div className="u-layout-row">
                            <div className="u-align-left u-container-style u-layout-cell u-right-cell u-shape-rectangle u-size-24 u-layout-cell-1">
                                <div className="u-container-layout u-container-layout-1">
                                    <h2 className="u-custom-font u-font-montserrat u-text u-text-palette-2-base u-text-1">
                                        Coupon Vault
                                    </h2>
                                    <p className="u-text u-text-palette-2-base u-text-2">
                                        A Headless Promotion Engine to create
                                        and distribute coupons with ease.
                                    </p>
                                    <p className="u-text u-text-palette-2-base u-text-3">
                                        Read the&nbsp;
                                        <a
                                            href="https://coupon-vault-documentation.vercel.app/"
                                            rel="noreferrer"
                                            className="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-hover-palette-2-dark-2 u-text-palette-2-base u-btn-1"
                                            target="_blank"
                                        >
                                            Documentation
                                        </a>
                                    ...
                                    <a
                                        href="/merchant"
                                        className="u-active-palette-2-base u-border-2 u-border-active-palette-2-base u-border-hover-palette-2-base u-border-palette-3-base u-btn u-btn-round u-button-style u-hover-palette-2-base u-palette-3-base u-radius-12 u-text-active-white u-text-hover-white u-text-palette-2-base u-btn-2"
                                    >
                                        GET STARTED
                                    </a>
                                </div>
                            </div>
                            <div className="u-align-center u-container-style u-layout-cell u-left-cell u-size-36 u-layout-cell-2">
            ...
            <section
                className="u-align-center u-clearfix u-palette-2-base u-section-2 px-6"
                id="sec-e6ed"
            >
                <div className="u-clearfix u-sheet u-valign-middle u-sheet-1">
                    <h1 className="u-text u-text-default u-text-palette-3-base u-text-1">
                        Vast Range of Features
                    </h1>
                    <p className="u-text u-text-default u-text-2">
                        Take Your Promotional Campaigns To The Next Level
                    </p>
                        ...
                        <div className="u-repeater u-repeater-1">
                            <div className="u-align-center u-container-style u-list-item u-radius-15 u-repeater-item u-shape-round u-white u-list-item-1">
                                <div className="u-container-layout u-similar-container u-container-layout-1">
                                    <span className="u-icon u-icon-circle u-palette-3-base u-text-palette-2-base u-icon-1">
                                        <svg
                                    ...
                                    <h5 className="u-custom-font u-font-raleway u-text u-text-default u-text-palette-2-base u-text-3">
                                        STATic COUPONS
                                    </h5>
                                    <p className="u-text u-text-palette-2-dark-2 u-text-4">
                                        Create Static Coupons that are easy to
                                        create and distribute.
                                        <br />
                                        Simply specify some limits and let
                                        Coupon Vault handle the rest.
                                    </p>
                                    <a
                                        href="###"
                                        className="u-active-palette-2-base u-btn u-btn-round u-button-style u-hover-palette-2-base u-palette-3-base u-radius-50 u-text-active-palette-3-base u-text-hover-palette-3-base u-text-palette-2-base u-btn-1"
                                    >
                                        more
                                    </a>
                                </div>
                            ...
                            <div className="u-align-center u-container-style u-list-item u-radius-15 u-repeater-item u-shape-round u-white u-list-item-2">
                                <div className="u-container-layout u-similar-container u-container-layout-2">
                                    <span className="u-icon u-icon-circle u-palette-3-base u-text-palette-2-base u-icon-2">
                                        <svg
                                            className="u-svg-link"
                                            preserveAspectRatio="xMidYMin slice"
                                            viewBox="0 0 512 512"
                                    ...
                                    <h5 className="u-custom-font u-font-raleway u-text u-text-default u-text-palette-2-base u-text-5">
                                        Dynamic COUPONS
                                    </h5>
                                    <p className="u-text u-text-palette-2-dark-2 u-text-6">
                                        Create Dynamic Coupons that are talor
                                        made for specific users.
                                        <br />
                                        Easily give out loyality benefits and
                                        MISSYOU Coupons.
                                    </p>
                                    <a
                                        href="###"
                                        className="u-active-palette-2-base u-btn u-btn-round u-button-style u-hover-palette-2-base u-palette-3-base u-radius-50 u-text-active-palette-3-base u-text-hover-palette-3-base u-text-palette-2-base u-btn-2"
                                    >
                                        more
                                    </a>
                                </div>
                            ...
                            <div className="u-align-center u-container-style u-list-item u-radius-15 u-repeater-item u-shape-round u-white u-list-item-3">
                                <div className="u-container-layout u-similar-container u-container-layout-3">
                                    <span className="u-icon u-icon-circle u-palette-3-base u-text-palette-2-base u-icon-3">
                                        <svg
                                            className="u-svg-link"
                                            preserveAspectRatio="xMidYMin slice"
                                            viewBox="0 0 512 512"
                                        ...
                                        >
                                            ...
                                            <path d="m488.660156 211.898438c14.285156-12.460938 23.339844-30.773438 23.339844-51.175782 0-37.449218-30.464844-67.914062-67.914062-67.914062-37.449219 0-67.914063 30.464844-67.914063 67.914062 0 23.597656 12.105469 44.417969 30.425781 56.59375-10.726562 11.054688-17.347656 26.113282-17.347656 42.695313v50.988281h-32.9375c-24.984375 0-45.3125 20.328125-45.3125 45.3125v155.6875h100.875v-100.125h100.125v-151.859375c0-19.488281-9.136719-36.867187-23.339844-48.117187zm-44.574218-89.089844c20.90625 0 37.914062 17.007812 37.914062 37.914062s-17.007812 37.917969-37.914062 37.917969-37.914063-17.011719-37.914063-37.917969 17.007813-37.914062 37.914063-37.914062zm37.914062 259.066406h-100.125v100.125h-40.875v-125.6875c0-8.441406 6.871094-15.3125 15.3125-15.3125h62.9375v-80.984375c0-17.300781 14.074219-31.375 31.375-31.375s31.375 14.074219 31.375 31.375zm0 0" />
                                            <path d="m352 121.664062v-79.332031c0-23.34375-18.988281-42.332031-42.332031-42.332031h-107.335938c-23.34375 0-42.332031 18.988281-42.332031 42.332031v79.332031c0 23.34375 18.988281 42.335938 42.332031 42.335938h18.171875l35.496094 61.480469 35.496094-61.480469h18.171875c23.34375 0 42.332031-18.992188 42.332031-42.335938zm-30 0c0 6.804688-5.53125 12.335938-12.332031 12.335938h-35.492188l-18.175781 31.480469-18.175781-31.480469h-35.492188c-6.800781 0-12.332031-5.53125-12.332031-12.335938v-79.332031c0-6.800781 5.53125-12.332031 12.332031-12.332031h107.335938c6.800781 0 12.332031 5.53125 12.332031 12.332031zm0 0" />
                                        </svg>
                                    </span>
                                    <h5 className="u-custom-font u-font-raleway u-text u-text-default u-text-palette-2-base u-text-7">
                                        CAMPAIGNS
                                    </h5>
                                    <p className="u-text u-text-palette-2-dark-2 u-text-8">
                                        Create and customize marketing campaigns
                                        with ease. Auto create coupons and track
                                        sucess of the campaign
                                    </p>
                                    <a
                                        href="###"
                                        className="u-active-palette-2-base u-btn u-btn-round u-button-style u-hover-palette-2-base u-palette-3-base u-radius-50 u-text-active-palette-3-base u-text-hover-palette-3-base u-text-palette-2-base u-btn-3"
                                    >
                                        more
                                    </a>
                                </div>
                            ...
                            <div className="u-align-center u-container-style u-list-item u-radius-15 u-repeater-item u-shape-round u-white u-list-item-4">
                                <div className="u-container-layout u-similar-container u-container-layout-4">
                                    <span className="u-icon u-icon-circle u-palette-3-base u-text-palette-2-base u-icon-4">
                                        <svg
                                            className="u-svg-link"
                                            preserveAspectRatio="xMidYMin slice"
                                    ...
                                    <h5 className="u-custom-font u-font-raleway u-text u-text-default u-text-palette-2-base u-text-9">
                                        CUstomers &amp; PRoducts
                                    </h5>
                                    <p className="u-text u-text-palette-2-dark-2 u-text-10">
                                        Manage your customers and product SKUs.
                                        Coupon Vault intergates with your
                                        datebase and lets you create customer
                                        specifc coupons
                                    </p>
                                    <a
                                        href="###"
                                        className="u-active-palette-2-base u-btn u-btn-round u-button-style u-hover-palette-2-base u-palette-3-base u-radius-50 u-text-active-palette-3-base u-text-hover-palette-3-base u-text-palette-2-base u-btn-4"
                                    >
                                        more
                                    </a>
                                </div>
                            </div>
                            <div className="u-align-center u-container-style u-list-item u-radius-15 u-repeater-item u-shape-round u-white u-list-item-5">
                                <div className="u-container-layout u-similar-container u-container-layout-5">
                                    <span className="u-icon u-icon-circle u-palette-3-base u-text-palette-2-base u-icon-5">
                                        <svg
                                            className="u-svg-link"
                                            preserveAspectRatio="xMidYMin slice"
                                        ...
                                        >
                                            <g>
                                                <path d="m353.944 0h-195.89c-31.033 0-56.281 25.248-56.281 56.281v399.437c0 31.033 25.248 56.281 56.281 56.281h195.891c31.033 0 56.281-25.248 56.281-56.281v-399.437c0-31.033-25.248-56.281-56.282-56.281zm-195.89 30h195.891c14.491 0 26.281 11.79 26.281 26.281v2.001h-248.454v-2.001c0-14.491 11.79-26.281 26.282-26.281zm-26.282 368.993v-310.711h248.453v310.711zm222.172 83.005h-195.89c-14.491 0-26.281-11.79-26.281-26.281v-26.725h109.227v25.003h30v-25.003h109.227v26.725c-.001 14.491-11.791 26.281-26.283 26.281z" />
                                                <path d="m360.457 243.178-104.458-88.783-104.458 88.783 19.428 22.858 14.604-12.413v75.568h140.852v-75.568l14.604 12.413zm-64.032 56.014h-25.426v-32.048h-30v32.048h-25.426v-71.066l40.426-34.359 40.426 34.359z" />
                                            </g>
                                        </svg>
                                    </span>
                                    <h5 className="u-custom-font u-font-raleway u-text u-text-default u-text-palette-2-base u-text-11">
                                        Clustering model
                                    </h5>
                                    <p className="u-text u-text-palette-2-dark-2 u-text-12">
                                        Find the most&nbsp;influential
                                        parameters for your customers and
                                        products with our Machine Learning Model
                                        and target those in your future
                                        campaigns.
                                    </p>
                                    <a
                                        href="###"
                                        className="u-active-palette-2-base u-btn u-btn-round u-button-style u-hover-palette-2-base u-palette-3-base u-radius-50 u-text-active-palette-3-base u-text-hover-palette-3-base u-text-palette-2-base u-btn-5"
                                    >
                                        more
                                    </a>
                                </div>
                            </div>
                            <div className="u-align-center u-container-style u-list-item u-radius-15 u-repeater-item u-shape-round u-white u-list-item-6">
                                <div className="u-container-layout u-similar-container u-container-layout-6">
                                    <span className="u-icon u-icon-circle u-palette-3-base u-text-palette-2-base u-icon-6">
                                        <svg
                                            className="u-svg-link"
                                            preserveAspectRatio="xMidYMin slice"
                                            viewBox="0 0 512 512"
                                    ...
                                    <h5 className="u-custom-font u-font-raleway u-text u-text-default u-text-palette-2-base u-text-13">
                                        Easy Promotion
                                    </h5>
                                    <p className="u-text u-text-palette-2-dark-2 u-text-14">
                                        Send out Promotional Emails and Whatsapp
                                        Messages with a click of a button. Share
                                        Static Coupons with easy and track their
                                        success.
                                    </p>
                                    <a
                                        href="###"
                                        className="u-active-palette-2-base u-btn u-btn-round u-button-style u-hover-palette-2-base u-palette-3-base u-radius-50 u-text-active-palette-3-base u-text-hover-palette-3-base u-text-palette-2-base u-btn-6"
                                    >
                                        more
                                    </a>
                                </div>
            ...
            <section
                className="u-align-center u-clearfix u-white u-section-3"
                id="carousel_3c51"
            >
                <div className="u-clearfix u-sheet u-valign-middle u-sheet-1">
                    <h2 className="u-text u-text-default u-text-palette-2-base u-text-1">
                        Frequently Asked Questions
                    </h2>
                    <div className="u-border-9 u-border-palette-2-base u-line u-line-horizontal u-line-1" />
                    <div className="u-accordion u-faq u-spacing-10 u-accordion-1">
                        <div className="u-accordion-item">
                            <a
                                onClick={() => setDtoggle(!dtoggle)}
                                className="u-accordion-link u-active-palette-2-base u-button-style u-hover-palette-2-base u-palette-3-base u-radius-12 u-text-active-white u-text-hover-grey-10 u-text-palette-2-base u-accordion-link-1"
                                id="link-accordion-ae6a"
                                aria-controls="accordion-ae6a"
                                aria-selected="true"
                            >
                                <span className="u-accordion-link-text">
                                    {" "}
                                    What is a headless promotion engine?
                                </span>
                                <span className="u-accordion-link-icon u-icon u-icon-circle u-text-active-white u-text-hover-white u-text-palette-2-base u-icon-1">
                                    <svg
                                        className="u-svg-link"
                                        preserveAspectRatio="xMidYMin slice"
                            ...
                            >
                                <p
                                    className={
                                        dtoggle ? `text-white  px-6` : `hidden`
                                    }
                                >
                                    A headless promotion engine is a software
                                    application that allows merchants to create
                                    and manage various types of promotions, such
                                    as discounts, coupons, and gift cards,
                                    without being tied to a specific e- commerce
                                    platform or frontend. Unlike traditional
                                    promotion tools that are built into
                                    e-commerce platforms and tightly coupled
                                    with the frontend, a headless promotion
                                    engine is decoupled from the frontend and
                                    can be integrated into any platform or
                                    application through APIs. This allows
                                    merchants to create and manage promotions
                                    independently of the frontend and gives them
                                    the flexibility to use the promotions engine
                                    with any frontend technology. A headless
                                    promotion engine can be tailored to meet the
                                    specific needs of merchants, such as setting
                                    conditions for promotions, targeting
                                    specific customer segments, and tracking the
                                    effectiveness of promotions. Additionally,
                                    it can be integrated with various
                                    third-party tools and services, such as
                                    email marketing platforms and loyalty
                                    programs, to create a seamless promotional
                                    experience for customers. Overall, a
                                    headless promotion engine provides merchants
                                    with greater flexibility, control, and
                                    customisation options when it comes to
                                    creating and managing promotions for their
                        ...
                        <div className="u-accordion-item">
                            <a
                                ...
                                className="u-accordion-link u-active-palette-2-base u-button-style u-hover-palette-2-base u-palette-3-base u-radius-12 u-text-active-white u-text-hover-grey-10 u-text-palette-2-base u-accordion-link-2"
                                id="link-accordion-8339"
                                aria-controls="accordion-8339"
                                aria-selected="false"
                            >
                                <span className="u-accordion-link-text">
                                    {" "}
                                    What are dynamic coupon codes?
                                    <br />
                                </span>
                                <span className="u-accordion-link-icon u-icon u-icon-circle u-text-active-white u-text-hover-white u-text-palette-2-base u-icon-2">
                                    <svg
                                        className="u-svg-link"
                                        preserveAspectRatio="xMidYMin slice"
                                        viewBox="0 0 451.847 451.847"
                            ...
                            >
                                <p
                                    className={
                                        mtoggle ? `text-white px-6` : `hidden`
                                    }
                                >
                                    Dynamic coupon codes are unique, one-time
                                    use codes that are generated in real-time by
                                    a system and are dynamically assigned to a
                                    customer. Each code can only be used once
                                    and is generated based on a set of rules or
                                    conditions defined by the merchant, such as
                                    a minimum order value or a specific product
                                    category. The advantage of dynamic coupon
                                    codes is that they allow merchants to offer
                                    personalised discounts to individual
                                    customers, without the risk of the coupon
                                    code being shared or used by others. This
                                    can help merchants to improve customer
                                    loyalty and retention by offering a more
                                    targeted and personalised promotional
                                    experience. Dynamic coupon codes can be
                                    delivered to customers through various
                                    channels, such as email, SMS, or push
                                    notifications, and can be redeemed online or
                                    in-store, depending on the merchants setup.
                                    They can also be 1 of 3 integrated with a
                                    merchants loyalty program to reward
                                    customers for their purchases and
                                    engagement. Overall, dynamic coupon codes
                                    provide merchants with a powerful
                                    promotional tool that can help drive sales
                                    and improve customer engagement by offering
                                    personalised and targeted discounts to
                        ...
                        <div className="u-accordion-item">
                            <a
                                onClick={() => setStoggle(!stoggle)}
                                className="u-accordion-link u-active-palette-2-base u-button-style u-hover-palette-2-base u-palette-3-base u-radius-12 u-text-active-white u-text-hover-grey-10 u-text-palette-2-base u-accordion-link-3"
                                id="link-accordion-1c17"
                                aria-controls="accordion-1c17"
                                aria-selected="false"
                            >
                                <span className="u-accordion-link-text">
                                    {" "}
                                    What are static coupon codes?
                                    <br />
                                </span>
                                <span className="u-accordion-link-icon u-icon u-icon-circle u-text-active-white u-text-hover-white u-text-palette-2-base u-icon-3">
                                    <svg
                                        className="u-svg-link"
                                        preserveAspectRatio="xMidYMin slice"
                                        viewBox="0 0 451.847 451.847"
                            ...
                            <div
                                className={stoggle ? `text-white` : `hidden`}
                                id="accordion-1c17"
                            ...
                            >
                                <div className="u-container-layout u-container-layout-3">
                                    <div className="fr-view u-clearfix u-rich-text u-text">
                                        <p>
                                            Static coupon codes are a type of
                                            coupon code that is pre-generated
                                            and can be used multiple times by
                                            different customers until the code
                                            expires or is deactivated. Merchants
                                            create static coupon codes with a
                                            fixed discount value, such as a
                                            percentage off the total purchase or
                                            a flat discount amount. Static
                                            coupon codes are typically
                                            distributed to customers through
                                            various channels, such as email,
                                            social media, or advertising
                                            campaigns, and can be redeemed
                                            online or in-store, depending on the
                                            merchants setup. Static coupon codes
                                            are a common promotional tool used
                                            by merchants to attract new
                                            customers, incentivise repeat
                                            purchases, and increase sales during
                                            seasonal or holiday events. They can
                                            also be used to reward loyal
                                            customers, generate buzz around new
                                            products or services, and encourage
                                            customer referrals. The main
                                            advantage of static coupon codes is
                                            that they are easy to create and
                                            distribute, and can be tracked and
                                            analysed to measure their
                                            effectiveness. However, because they
                                            are not personalised, they may be
                                            less effective in driving customer
                                            engagement and loyalty compared to
