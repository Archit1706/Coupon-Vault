            ...
            <div className=" px-5 h-screen m-auto flex flex-wrap items-center">
                <div className="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0 sm:pt-12">
                    <h1 className="title-font font-medium text-3xl text-gray-900 dark:text-white">
                        Setting{" "}
                        <span className="text-blue-500">up your Coupons.</span>
                    </h1>
                    ...
                    <p className="leading-relaxed mt-4 dark:text-gray-300">
                        <Typewriter
                            options={{
                                strings: [
                                    "Join Coupon Vault and start saving.",
                                    "Unlock exclusive deals with Coupon Vault.",
                                    "Sign up for free and start saving.",
                                    "Never miss a deal again with Coupon Vault.",
                                    "Discover new ways to save with Coupon Vault.",
                                ],
                                autoStart: true,
                                loop: true,
                                deleteSpeed: 30,
